...
|------|--------|---------|-----------|-------|
| 1.1 catalog.yaml | ⬜ TODO | - | - | Aggiunge latency + multi-provider |
| 1.2 intake_bridge.py | ⬜ TODO | - | - | Bridge a client esistenti |
| 1.3 catalog API | ⬜ TODO | - | - | Endpoint REST |

## 🛰️ Phase 2: CYGNSS Client (PARALLELIZZABILE)

| Task | Status | Started | Completed | Notes |
|------|--------|---------|-----------|-------|
| 2.1 cygnss_client.py | ⬜ TODO | - | - | HIGH priority, NASA near-RT |
